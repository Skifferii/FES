...
import predicate.PredicateAccountByGivenLimit;
import predicate.PredicateAccountsByAge;
import predicate.PredicateAccountsByOwnerName;
...
public class Main {
    ...
    public static  List<Account> getAccountsByOwner(List<Account> list, Person owner){
        PredicateAccountsByOwnerName predicate = new PredicateAccountsByOwnerName(owner);//
        return filterAccounts(list, predicate);
    }
